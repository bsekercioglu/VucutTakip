...
const LoginPage: React.FC = () => {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    if (success) {
      ...
      alert('Giriş başarısız. E-posta ve şifrenizi kontrol edin.');
    }
  };
      ...
      <div className="max-w-md w-full space-y-8 bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Vücut takip yolculuğunuza devam edin
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full bg-blue-800 text-white py-3 px-4 rounded-lg hover:bg-blue-900 transition-colors font-medium flex items-center justify-center"
            >
              <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <p className="text-sm text-gray-600 text-center">
              ...
              E-posta: demo@vucuttakip.com<br />
              Şifre: demo123
            </p>
          </div>
        </form>
